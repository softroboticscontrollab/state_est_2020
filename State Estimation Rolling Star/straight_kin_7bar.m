function [stright_tips,ms] = straight_kin_7bar(T0_n,T0_np,a,K,Ls)
%
...
%% Determine the slopes of all the stright sections
...
for i = 1:num_limbs-1
    ...
    if Pnt1_1(2)<0
        stright_tips(1,i) = P0t1_0(1);
        stright_tips(2,i) = P0t1_0(2);
    elseif Pnt1_1(2)>0
        stright_tips(1,i) = P0t2_0(1);
        stright_tips(2,i) = P0t2_0(2);
    else %Pnt1_1(2) == 0
        stright_tips(1,i) = P0t1_0(1);
        stright_tips(2,i) = P0t1_0(2);
    end
...
if P0t1_0(2) < 0
    stright_tips(1,num_limbs) = P0t1_0(1);
    stright_tips(2,num_limbs) = P0t1_0(2);
elseif P0t1_0(2) > 0
    stright_tips(1,num_limbs) = P0t2_0(1);
    stright_tips(2,num_limbs) = P0t2_0(2);
else %P0t1_0(2) == 0
    stright_tips(1,num_limbs) = P0t1_0(1);
    stright_tips(2,num_limbs) = P0t1_0(2);
end
