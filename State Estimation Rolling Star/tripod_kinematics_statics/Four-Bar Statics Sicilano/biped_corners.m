...
x4 = vertices_feet{2}(1,1);

% top left corner = second limb node 1
x2 = vertices_limbs{2}(1,1);
y2 = vertices_limbs{2}(2,1);
% top right corner = third limb node 1
x3 = vertices_limbs{3}(1,1);
y3 = vertices_limbs{3}(2,1);
